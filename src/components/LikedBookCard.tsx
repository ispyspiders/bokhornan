...
const LikedBookCard = ({ thumbnail, title, bookId, readonly }: LikedBookCardProps) => {
    ...
    return (
        <div className="bg-light rounded-lg p-4 drop-shadow-sm w-fit border-2 border-blush-deep font-montserrat max-w-40 flex flex-col justify-between items-start">
